...
const faqs = [
  {
    ...
    q: "Is Mervil Catalyst just for kids who want to be programmers or go into tech?",
    a: `No — and this is probably the most important thing to understand about Mervil Catalyst.\n\nMervil Catalyst is a full, accredited high school that covers every subject you'd find in any D11 high school: English, math, science, history, and electives. Students graduate with a standard D11 diploma. The difference isn't what subjects are covered — it's how they're taught and what they're connected to.\n\nAt Mervil Catalyst, every subject is taught through the lens of real-world application and future relevance. A student who loves writing might find themselves drafting technical documentation for a cybersecurity project. A student drawn to history might explore the geopolitics of space exploration. A student interested in art might work on UX design.\n\nTechnology touches every career field. Mervil Catalyst prepares students for that reality — regardless of whether they ever write a single line of code.`,
    featured: true,
  },
  {
    category: "About the School",
    q: "What kind of student thrives at Mervil Catalyst?",
    a: `Curious ones. That's the honest answer.\n\nMervil Catalyst is designed for students who learn best by doing, not just by listening. Students who want to understand why something matters, not just memorize it for a test. Students who are ready to take some ownership of their learning and aren't looking for someone to hand them everything.\n\nThat said, "thriving" at Mervil Catalyst doesn't mean arriving with confidence or knowing what you want. Many students come in uncertain, a little lost, or just feeling like traditional school has never quite fit. The structure, the mentors, and the environment are designed to help those students find their footing.\n\nYou don't need to be a high achiever. You need to be willing to try.`,
    featured: false,
  },
  {
    category: "Admissions & Cost",
    q: "Is Mervil Catalyst free? What does it actually cost?",
    a: `Mervil Catalyst is a publicly funded school within Colorado Springs School District 11. Tuition is completely free — always.\n\nAs a D11 school, Mervil Catalyst is funded through the same public mechanisms as any other D11 high school. There is no tuition, no enrollment fee, and no pay-to-play model. Some elective activities or materials may have small associated costs (as is standard at any public school), but the school, its programs, and its industry connections are entirely free to attend.\n\nThis is intentional. Access to the careers of the future shouldn't be determined by a family's income. If Mervil Catalyst only served students whose families could afford private alternatives, it would be failing its own mission.`,
    featured: false,
  },
  {
    category: "Admissions & Cost",
    q: "Who can apply? What does 'application-based' mean?",
    a: `Any student entering 9th or 10th grade in the D11 area can apply. Mervil Catalyst is planning for approximately 100 students per cohort year, growing to a full 9–12 school of 400–500 students over time.\n\n"Application-based" does not mean academically selective. It is not like applying to a competitive magnet school where only top students get in. The application exists to ensure that students who enroll have genuinely chosen to be there — that they (and their families) understand what Mervil Catalyst is and are intentionally choosing this environment.\n\nFactors like GPA, test scores, or prior tech experience are not filters for admission. The school wants students who are motivated, curious, and ready for a different kind of high school — not students who have already proven they can excel in a traditional one.\n\nInformation Nights are a great first step before applying — they help families ask real questions and get a feel for whether Mervil Catalyst is the right fit.`,
    featured: false,
  },
  {
    category: "Academics",
    q: "Will students still graduate with a regular high school diploma?",
    a: `Yes, completely standard. Mervil Catalyst follows D11 graduation requirements in full. Every student who completes the program earns a Colorado Springs School District 11 high school diploma — the same credential as any other D11 graduate.\n\nOn top of that, students have significant opportunities to earn college credit through dual enrollment partnerships with UCCS and Pikes Peak State College. These aren't simulated or watered-down college courses — they're the real thing, listed on a real college transcript, potentially saving students (and families) significant tuition costs down the road.`,
    featured: false,
  },
  {
    category: "Academics",
    q: "How does dual enrollment work? What can students actually take?",
    a: `Mervil Catalyst students have access to two full college catalogs — no prerequisites beyond Mervil Catalyst's concurrent enrollment agreements with each institution.\n\n**University of Colorado Colorado Springs (UCCS)** is a full four-year research university with 9 colleges, 60+ undergraduate degree programs, and 1,000+ courses across every discipline — business, engineering, computer science, the sciences, humanities, education, and more. Mervil Catalyst students can take real UCCS courses on campus or online, alongside traditional college students, earning credit that appears on an official UCCS transcript.\n\n**Pikes Peak State College (PPSC)** offers 200+ certificate and degree programs across career/technical, workforce, and transfer pathways. PPSC courses can be taken on a PPSC campus, online, or through Campus Pathways delivered directly at Mervil Catalyst. Credits earned are fully transferable to Colorado public universities.\n\nStudents work with their Mervil Catalyst counselor to identify courses that align with their interests and count toward both high school requirements and future college plans. For many students, this means entering their freshman year of college with a semester or more of credit already completed — tuition-free.`,
    featured: false,
  },
  {
    category: "Academics",
    q: "Do students have to specialize? What if they're interested in multiple areas?",
    a: `Exploration is the default mode at Mervil Catalyst, not specialization.\n\nStudents aren't assigned a "track" on day one and locked in. The school is designed to expose students to a broad range of technology, industry, and career pathways — and let their interests emerge through that exposure. Some students will arrive knowing exactly what they want and go deep. Most will arrive uncertain, explore widely, and narrow their focus over time.\n\nEven students who do identify a strong interest are still completing a full, balanced high school curriculum alongside their area of focus. Depth of interest in one area doesn't mean ignoring everything else.`,
    featured: false,
  },
  {
    category: "The Environment",
    q: "What is a normal day at Mervil Catalyst actually like?",
    a: `The honest answer is: different from what you're used to.\n\nMervil Catalyst doesn't run a rigid bell-schedule of 45-minute periods where you sit at a desk while a teacher talks. The environment is closer to a professional workspace: team areas for project work, meeting rooms for presentations and collaboration, subject-specific labs for hands-on technical work, and common areas for independent focus.\n\nStudents manage more of their own time and schedule than in a traditional high school. Teachers act as mentors and coaches — guiding students through material and projects rather than delivering lectures to passive audiences. There are still structured learning blocks, direct instruction, and clear academic expectations. But the culture is one of ownership: students are treated as capable young adults, and expected to show up like it.\n\nFor students who've always felt like the traditional model wasn't built for them — that's by design.`,
    featured: false,
  },
  {
    category: "The Environment",
    q: "What's the relationship between Mervil Catalyst and its industry partners? Is it just branding?",
    a: `It's not branding — the partners are physically present and structurally involved.\n\nMervil Catalyst is co-located at the UCCS Cybersecurity Center, which means the National Cybersecurity Center is next door. Students walk past working professionals every day. Industry mentors come in to review student projects, present on their fields, and engage directly with coursework.\n\nThe Board of Directors is made up of the CEOs and leaders of Mervil Catalyst's ecosystem partners — the Space ISAC Executive Director, the NCC CEO, the Pikes Peak State College President, the USAFA's Department of Computer and Cyber Sciences head, and others. These aren't advisory board placeholders; they are actively governing the school.\n\nThrough Exponential Impact, students have access to a real startup accelerator's mentor network — not a simulation of one. The connections students make at Mervil Catalyst are with people who work in these industries, not just people who teach about them.`,
    featured: false,
  },
  {
    category: "Applying",
    q: "How do I learn more or attend an Information Night?",
    a: `Information Nights are the best first step. They're held at the school at 3650 N. Nevada Avenue — enter on the west side of the building at the Mervil Catalyst entrance. All nights start at 6:00 PM. You'll meet the staff, tour the facility, and get real answers to real questions.\n\nFuture information night dates are posted on the website as they're scheduled. You can also reach the school directly:\n\n• Email: info@csrockets.org\n• Contact: nathan.gorsch@d11.org\n• Website: csrockets.org\n\nApplications are submitted through the school website. The process is straightforward — the goal is to start a conversation, not to screen students out.`,
    featured: false,
  },
];
    ...
    <section id="faq" ref={ref} className="relative py-28 bg-[#0A0A0F] overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mb-14">
          ...
          >
            Start with the most important one: Mervil Catalyst is for{" "}
